$(document).ready(function() {
    ...
    $('.chat-header').on('click', '[data-close]', function(e) {
        e.preventDefault()
        $(".main").removeClass("main-visible")
    });
    ...
    $('[data-chat-filter]').on('click', function() {
        ...
        if (selectedOption === 'all-chats') { $('[data-chat-list]').find('li').each(function() { $(this).show() }); } else {
            $('[data-chat-list]').find('li').each(function() { $(this).hide() });
    ...
    $('[data-call-filter]').on('click', function() {
        ...
        if (selectedOption === 'all-calls') { $('[data-call-list]').find('li').each(function() { $(this).show() }); } else {
            $('[data-call-list]').find('li').each(function() { $(this).hide() });
    ...
    $(document).on('change', '.custom-file-input', function(event) {
        ...
        commonUploadFile(event.target.files[0], $(this));
    });
