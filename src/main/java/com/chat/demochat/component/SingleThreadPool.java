...
public class SingleThreadPool
{
    ...
    public SingleThreadPool(int num)
    {
        ...
        for (int i = 0; i < num; i++)
        {
            SingleThreadPoolExecutor singleThreadPoolExecutor = new SingleThreadPoolExecutor("websocket-" + i, 0L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue<>(), new WSThreadFactory(i + ""), (r, executor) -> log.info("忽略该执行"));
